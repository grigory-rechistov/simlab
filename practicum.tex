...
%
\documentclass[a5paper,10pt, oneside, titlepage, numbers=endperiod]{scrbook}
%\documentclass[a4paper,10pt,twoside,titlepage]{book} % swap for latex2rtf

\def \documentversion {0.5} % increment and don't forget to update history.tex
...
\usepackage{hyperref}
\hypersetup{colorlinks=true, linkcolor=black, filecolor=black, citecolor=black, urlcolor=black , pdfauthor=Evgeny Yulyugin, pdftitle=Лабораторный проктикум по программному моделированию}
...
\typeout{Copyright 2012, 2013 Grigory Rechistov and Evgeny Yulyugin.}
\begin{document}
...
\iftoggle{webpaper}{
    % Nothing for the web version
    % bibliography is already in place
} {
    \include{literature}
    \include{lastpage}
}
