This folder contains sources for the Simulation Practicum Book.
Данный проект содержит исходные тексты книги «Лабораторный практикум по программному моделированию».
